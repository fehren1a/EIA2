/*
Aufgabe: 6a - Interfaces: Assoziative Bienen
...
(function (L6a_Interface) {
    ...
    function addnewbee(_event) {
        squares.push({ x: 635, y: 310, color: "hsl(" + Math.random() * 360 + ", 100%, 50%)", size: Math.random() * 3.3 + 3 });
        count += 1;
    }
